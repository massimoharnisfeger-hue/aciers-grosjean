...
- Mise en veille : sur secteur, le PC du propriétaire ne se met jamais en veille (réglage Windows) ; sur batterie, après 3 min. Pour une nuit de rendu sans toucher aux réglages : demande « système requis » (`SetThreadExecutionState`, `eveil.ps1` du scratchpad, levée à 9 h). Ne protège ni de la fermeture du capot ni d'une batterie vide. `[vague 1, 15/09]`
