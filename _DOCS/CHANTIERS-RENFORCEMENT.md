...
| H4 | Service d'envoi des formulaires : route handler + SMTP de l'entreprise, ou service tiers (Resend, Formspree) ? Et vers quelle adresse ? | Bloque D4. Aujourd'hui des demandes de devis peuvent se perdre sans trace |
