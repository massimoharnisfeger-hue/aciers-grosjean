...
- **Rangement et noms des images (obligatoire) :**
  ...
  - Copie pour le propriétaire, au même moment : les mêmes fichiers dans `_DEPOT/images/visuels-3d/<univers>/<catégorie>/` (mêmes noms). C'est là qu'il consulte tous les visuels terminés ; ne jamais y mettre d'essais. Structure complète du dépôt d'images : `_DEPOT/LISEZ-MOI.txt`.
