...
- **Rangement et noms des images (obligatoire) :**
  ...
  - Copie pour le propriétaire, au même moment (demande du 15/09) : `_DEPOT/images/2-categories/<univers>/<catégorie>/fond-blanc/studio-<famille>.webp` et `…/<catégorie>/fiche-technique/<slug>-caracteristiques.webp`. C'est là qu'il consulte tous les visuels terminés ; ne jamais y mettre d'essais. Structure complète du dépôt d'images : `_DEPOT/LISEZ-MOI.txt`.
