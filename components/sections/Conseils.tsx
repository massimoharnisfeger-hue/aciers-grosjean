...
export default function Conseils() {
  ...
  const suite = articles.slice(1, 4);

  return (
    <section className="bg-white py-24 md:py-32">
      <div className="container-g">
        <Reveal className="mb-12 max-w-2xl">
          <span className="font-body text-xs uppercase tracking-[0.2em] text-soft">Conseils</span>
        ...
        <div className="mt-10 flex justify-center">
          <Link href="/conseils" className="btn-ghost">
            Les {articles.length} articles
