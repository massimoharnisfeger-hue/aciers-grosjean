...
| Visuels 3D des fiches produit | 455 fiches sur 477 en ligne, 22 en attente de réponse du propriétaire, rapport final au propriétaire jamais rendu. **24/09 : vues d'origine gardées, seule la finition change (ADR-0011) ; image de fiche servie entière, pièce, cotes et tableau utile, en 2400 px (ADR-0012). Série en cours dans la séance web, branche `claude/gracious-cannon-iql9zs` : 24 familles (222 fiches + 23 studios), intégrées famille par famille après vérification indépendante ; les autres familles ont retrouvé leur image d'origine entière** (`_JOURNAL/2026-09-24.md`) | `_DOCS/rendus-3d/avancement.md` |
