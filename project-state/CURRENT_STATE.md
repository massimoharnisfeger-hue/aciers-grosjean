...
| Visuels 3D des fiches produit | 455 fiches sur 477 en ligne, 22 en attente de réponse du propriétaire, rapport final au propriétaire jamais rendu. **24/09 : vues d'origine gardées, seule la finition change (ADR-0011) ; image de fiche servie entière, pièce, cotes et tableau utile, en 2400 px (ADR-0012). Série finie le 25/09 dans la séance web, branche `claude/gracious-cannon-iql9zs` (non publiée) : 24 familles (222 fiches + 23 studios) rendues ; 20 familles intégrées après vérification indépendante ; 4 (profil U alu, tubes carré et rectangulaire alu, cornières inox : 22 fiches bonnes) attendent la question 51 (coupe des photos studio en métal clair) ; les autres familles ont retrouvé leur image d'origine entière. Questions nouvelles 51 à 54** (`_JOURNAL/2026-09-25.md`) | `_DOCS/rendus-3d/avancement.md` |
